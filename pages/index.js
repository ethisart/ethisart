...
The NF-ETH can <strong><em>always</em></strong> be redeemed back to 1 ETH, but the artwork will in return be destroyed. Kind of like a digital piggy bank - to redeem the ETH you must break open the NF-ETH.
            ...
            <p>
              By connecting with an Ethereum wallet above, you will be able to mint an NF-ETH, using the "Wrap 1 ETH" button. You need to have at least 1 ETH + 0.01 ETH to cover wrapping fee + gas cost to wrap your ETH. After wrapping, your NF-ETH should show up in your account instantly.
            </p>
          </div>
          <div>
